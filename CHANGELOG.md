...
* [FIX][rust] Rejected `GetAccount` responses whose full account contents or storage header do not match the authenticated account header commitments ([#2539](https://github.com/0xMiden/rust-sdk/issues/2539)).
