...
* [FIX][cli] `new-wallet` and `new-account` now warn when an extra package contributes an account component with no procedures, while continuing to allow storage-only components ([#2534](https://github.com/0xMiden/rust-sdk/issues/2534)).
